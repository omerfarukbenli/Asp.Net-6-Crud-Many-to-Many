...
namespace Business.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IResponse<Category>> AddCategoryProduct(CreateandCategoryDto category)
        {

            try
            {
            var product = _mapper.Map<Category>(category);


            await _unitOfWork.Category.AddCategory(product);

            foreach (var pr in category.Products)
            {
                await _unitOfWork.Category.AddCategoryProduct(product.Id, pr);
            }
        ...
        public async Task<IResponse<GetCategoryDto>> Post(CreateCategoryDto categoryDto)
        {
            ...
            var existingCat = await _unitOfWork.Category.CategoryExists(categoryDto.Name);
